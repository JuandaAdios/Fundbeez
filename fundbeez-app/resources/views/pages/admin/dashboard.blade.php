...
@section('content')
    ...
    <section class="jumbotron text-start jumbotron-light">
        <div class="container">
            ...
            <a class="btn btn-lg rounded-pill me-3" href="/admin/export/company" style="background-color: #ffd600">Download Data Company</a>
            <button type="button" class="btn btn-lg rounded-pill" style="background-color: #0098ba" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">Upload Data Company</button>
